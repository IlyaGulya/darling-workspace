...
def main() -> None:
    ...
    assert inventory["summary"] == actual_summary == {"READY": 0, "RECOVERABLE_LOCAL": 47, "ALREADY_MIGRATED": 47}
    report = (ROOT / "docs/patch-stack-canonical-migration-report.md").read_text()
    for count, name in ((0, "READY"), (47, "RECOVERABLE_LOCAL"), (47, "ALREADY_MIGRATED")):
