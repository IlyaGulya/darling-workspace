...
def main() -> None:
    ...
    assert inventory["summary"] == actual_summary == {"READY": 6, "RECOVERABLE_LOCAL": 76, "ALREADY_MIGRATED": 12}
    report = (ROOT / "docs/patch-stack-canonical-migration-report.md").read_text()
    for count, name in ((6, "READY"), (76, "RECOVERABLE_LOCAL"), (12, "ALREADY_MIGRATED")):
