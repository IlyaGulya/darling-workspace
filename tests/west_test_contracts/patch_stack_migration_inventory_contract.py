...
def main() -> None:
    ...
    assert inventory["summary"] == actual_summary == {"READY": 0, "RECOVERABLE_LOCAL": 76, "ALREADY_MIGRATED": 18}
    report = (ROOT / "docs/patch-stack-canonical-migration-report.md").read_text()
    for count, name in ((0, "READY"), (76, "RECOVERABLE_LOCAL"), (18, "ALREADY_MIGRATED")):
