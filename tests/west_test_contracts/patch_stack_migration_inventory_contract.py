...
def main() -> None:
    ...
    assert inventory["summary"] == actual_summary == {"READY": 7, "RECOVERABLE_LOCAL": 76, "ALREADY_MIGRATED": 11}
    report = (ROOT / "docs/patch-stack-canonical-migration-report.md").read_text()
    for count, name in ((7, "READY"), (76, "RECOVERABLE_LOCAL"), (11, "ALREADY_MIGRATED")):
