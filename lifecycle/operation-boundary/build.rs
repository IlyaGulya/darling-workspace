...
const CONTROLLER_CLOSURE: &[&str] = &[
    ...
    "../../docs/lifecycle-controller-linux-v1.md",
    "../../docs/lifecycle-controller-quarantine-gc-v1.md",
    "../../docs/lifecycle-cohort-routing-v1.md",
    "../../docs/guest-namespace-authority-pilot-v1.md",
    ...
    "../../lifecycle/guest-namespace-authority-v1.json",
    ...
    "../../tests/run-lifecycle-linux-backend-contract.sh",
    ...
    "../../tests/west_test_contracts/guest_namespace_authority_contract.py",
    ...
    "../../tests/fixtures/lifecycle-cohort-v1/cohort_owner_drain.cpp",
